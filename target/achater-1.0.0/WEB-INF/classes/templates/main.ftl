                    ...
                    <div class="form-group mt-2">
                        <form method="post" action="/newMsg" enctype="multipart/form-data">
                            <div class="form-group">
                                <textarea class="form-control" name="text" placeholder="Insert message"
    ...
    <#list messages as message>
        ...
        <#else>
            ...
            <div class="m-2" style="widows: 80%;">
                <b><i href=""
                      onclick="document.getElementById('searchFld').value='${message.tag}'; document.getElementById('searchBtn').click();"
                      style="font-size: 8pt;">
                    <#if message.tag == "">
                    <#else>
                        #${message.tag}
